...
//Define a StateNotifierProvider to expose an instance off the CartNotifire
//Making is accessible within our app
...
// A notifier class to manage the cart state, extending stateNotifire
...
class CartNotifier extends StateNotifier<Map<String, Cart>> {
  ...
  void addProductToCart({
    ...
    if (state.containsKey(productId)) {
      //if the product is already in the cart, updates its quantity and maybe other detail
      state = {
        ...state,
        productId: Cart(
