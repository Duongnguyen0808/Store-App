...
import 'package:store_app/views/screens/order_detail_screen.dart';
...
class _OrderScreenState extends ConsumerState<OrderScreen> {
  ...
  Future<void> _deleteOrder(String orderId) async {
    // Khởi tạo một đối tượng OrderController để xử lý logic xóa đơn hàng
    final OrderController orderController = OrderController();

    try {
      // Gọi hàm xóa đơn hàng từ OrderController, truyền vào id đơn hàng và context
      await orderController.deleteOrder(id: orderId, context: context);
      // Sau khi xóa thành công, gọi hàm _fetchOrders để cập nhật lại danh sách đơn hàng
      _fetchOrders(); // Làm mới danh sách sau khi xóa
    } catch (e) {
